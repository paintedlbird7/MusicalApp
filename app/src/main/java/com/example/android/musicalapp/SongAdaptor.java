...
public class SongAdaptor {

    private Song currentSong;
    private TextView siouxsieTextView;
    ...
    public class SongAdapter extends ArrayAdapter<Song> {
        ...
        public SongAdapter(Activity context, ArrayList<Song> words) {
            ...
            super(context, 0, (List<Song>) words);
        }
...
// Get the {@link AndroidFlavor} object located at this position in the list
            ...
            siouxsieTextView.setText(currentSong.getmDefaultSong());
...
//        miwokTextView.setText(word_item.getMiwokTranslation());
            ...
            defaultTextView.setText(currentSong.getmDefaultSong());
